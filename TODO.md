...
- [ ] 単語を覚える問題機能を設計・実装する [plan](docs/plans/word-memorization-quiz.md)
  - [x] 記憶は１日後３日後７日後と間を伸ばしてテストすると覚えやすいと聞いたけどそれは確かか？
  ...
  - [ ] Phase 1: 設計確定・スペック更新（data-model.md の WordReviewState/Question 位置づけ + app-spec.md §3.2 の保留事項解消）
